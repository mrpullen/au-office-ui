...
export function configure(aurelia: FrameworkConfiguration) {
    aurelia.globalResources([
        ...
        './resources/elements/OfficeTextField/office-textfield',
        './resources/elements/OfficeTextField/textFieldTypeViewEngineHooks',
        './resources/elements/OfficeCheckBox/office-checkbox'
    ]);
}